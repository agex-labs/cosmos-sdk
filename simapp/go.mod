...
replace github.com/cometbft/cometbft => github.com/agex-labs/cometbft v0.38.6-2-agex

replace cosmossdk.io/store => github.com/agex-labs/cosmos-sdk/store v1.0.3-1-agex
